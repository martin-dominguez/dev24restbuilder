...
@Generated("")
@Path("/v1.0")
public abstract class BaseDev24ObjectResourceImpl
	implements Dev24ObjectResource, EntityModelResource,
			   VulcanBatchEngineTaskItemDelegate<Dev24Object> {
	...
	public Response postDev24ObjectBatch(
		...
		return responseBuilder.entity(
			vulcanBatchEngineImportTaskResource.postImportTask(
				Dev24Object.class.getName(), callbackURL, null, object)
		).build();
	}
	...
	public void create(
			java.util.Collection<Dev24Object> dev24Objects,
			Map<String, Serializable> parameters)
		throws Exception {

		for (Dev24Object dev24Object : dev24Objects) {
			postDev24Object(dev24Object);
		}
	}
